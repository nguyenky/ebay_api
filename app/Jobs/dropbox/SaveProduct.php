    ...
    public function handle()
    {
        try{
            $product = Product::create([
                ...
                'Image1'=>str_replace("-","_",$this->product['Image1']),
                'Image2'=>str_replace("-","_",$this->product['Image2']),
                'Image3'=>str_replace("-","_",$this->product['Image3']),
                'Image4'=>str_replace("-","_",$this->product['Image4']),
                'Image5'=>str_replace("-","_",$this->product['Image5']),
