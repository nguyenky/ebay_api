        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <div style="padding:0px 0px 15px;margin:0px;">
                        <form method="post" action="{{route('update-mode-test')}}">
                            {!! csrf_field() !!}

                            @if($system->mode_test)
                                <label class="checkbox-inline" style="padding-left:0px"><input type="radio" name="mode_test" value="0">Inactive</label>
                                <label class="checkbox-inline" style="padding-left:0px"><input type="radio" name="mode_test" checked="" value="1">Active</label>
                            @else
                                <label class="checkbox-inline" style="padding-left:0px"><input type="radio" name="mode_test" checked="" value="0">Inactive</label>
                                <label class="checkbox-inline" style="padding-left:0px"><input type="radio" name="mode_test" value="1">Active</label>
                            @endif
